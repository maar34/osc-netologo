...
;; Send any patch variable from a specific patch location
    (osc:send-agents "patches" patch 2 2 "pcolor" "pxcor") 
 
  
;; Send patch variables from all the patches!CPU Expensive!
    ;;(osc:send-agents "patches" patches "pcolor") 
