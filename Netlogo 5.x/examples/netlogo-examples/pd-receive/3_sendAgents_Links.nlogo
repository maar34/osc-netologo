...
;; Example modified from Link Breeds Example. 
...
blue-links-own [ weight ]  ;; link breeds own variable
...
;;  set-default-shape red-links "curved link"
  ask n-of 5 turtles [
    ...
    create-red-link-to one-of other turtles [
     ...
     ;; You can send any default or defined variable, check on menu -> Tools/Link Monitor for posibilities.
     (osc:send-agents "links" blue-links  "weight")
     (osc:send-agents "links" red-links  "end1" "shape" )
