...
to send-osc
  ...
  (osc:send-agents "turtles" turtles "tDistance" "xcor")

ask turtles [
if abs pxcor = max-pxcor
    [ (osc:send-agents "wall" turtle who "xcor") ]
  ;; bounce off top and bottom walls
  if abs pycor = max-pycor
    [ (osc:send-agents "wall" turtle who "ycor") ]
]
