...
to go
  ...
  set counter count turtles - 1
  
 ;; print turtles with [turtle 2 "WHO"  ]
  
  resize-nodes
  
;;  (osc:send-agents "node" turtles with [size > 1 ] "xcor" "ycor" "size") 
  (osc:send-agents "node" turtle counter "xcor" "ycor")
...
"" ""
PENS
"default" 1.0 2 -16777216 true "" "let degree 1"
